...
export default function LoginScreen({ navigation }: Props) {
  ...
  useEffect(() => {
    if (error) {
      Alert.alert('Error de Login', error, [{ text: 'OK', onPress: clearAuthError }]);
    }
          ...
          >
            <View style={styles.container}>
              ...
              <View style={styles.formContainer}>
                ...
                {loading ? (
                  <LoadingSpinner color={COLORS.WHITE} style={styles.loader} />
                ) : (
                  <Button
                    title="INGRESAR"
                    onPress={handleLogin}
                ...
                <View style={styles.linksContainer}>
                  <TouchableOpacity style={styles.linkButton} onPress={handleRegisterPress}>
                    <Typography style={styles.linkText}>Registrarme</Typography>
                  </TouchableOpacity>
                  ...
                  >
                    <Typography style={styles.linkText}>¿Olvidó su contraseña?</Typography>
                  </TouchableOpacity>
                </View>
              </View>
            </View>

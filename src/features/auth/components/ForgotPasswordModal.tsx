    ...
    <Modal visible={visible} transparent={true} animationType="fade" onRequestClose={onClose}>
      <View style={styles.overlay}>
        <View style={styles.modalContainer}>
          ...
          {/* Título */}
          <Typography variant="h2" style={styles.title} fontFamily="BarlowCondensed-Bold">
          ...
          <View style={styles.messageContainer}>
            <View style={styles.iconRow}>
              <Ionicons name="information-circle" size={24} color={COLORS.PRIMARY_GREEN} />
              <Typography
                variant="body"
                style={styles.message}
                fontFamily="BarlowCondensed-Regular"
              >
                Para recuperar su contraseña, por favor contacte con el administrador del club.
              </Typography>
            </View>
            ...
            <View style={styles.contactInfo}>
              <View style={styles.contactItem}>
                ...
                <Typography style={styles.contactText}>villamitre@surtekbb.com</Typography>
              </View>
            </View>
          </View>
